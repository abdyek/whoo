...
$serviceContainer->setAdapterClass('whoo', 'mysql');
...
$manager->setName('whoo');
$serviceContainer->setConnectionManager('whoo', $manager);
$serviceContainer->setDefaultDatasource('whoo');
